        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-12">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    <form action="{{route('edittestimonial', $testimonial->id)}}" method ="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        @if ($errors->any())
                    ...
                    <div class="form-floating mb-3">
                        <textarea name="content"  class="form-control" id="floatingInput" placeholder="anathing you say about me." required>{{$testimonial->content}}</textarea>
                        <label for="floatingInput">Content</label>
                    </div>
                    <div class="form-floating mb-4">
                        <input type="text" name="author" value="{{$testimonial->author}}" class="form-control" id="floatingPassword" placeholder="author" required>
