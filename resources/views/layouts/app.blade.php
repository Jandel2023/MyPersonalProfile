...
<head>
    ...
    <style>
        ...
        main {
            flex: 1;
            /* padding-bottom: 500px; adjust as needed */
        }
        footer {
            flex-shrink: 0;
            position: fixed;
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>{{(Auth::user()->dashboardname)}}</h3>
                </a>
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content" style="background-color: #191C24; color: green;">
          ...
          <div class="modal-body">
             ...
             <br>
             <div><p>{{Auth::user()->dashboardname}} </p></div>
