        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-12">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    <form action="{{ route('blogs.update',$testimonial->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="form-floating mb-3">
                        <input type="file" value="" name="image_blog" class="form-control" id="floatingText" placeholder="profile_image" accept="image/*" autofocus>
                        <label for="floatingText">Image</label>
                    </div>

                    <div class="form-floating mb-4">
                        <input type="text" name="title" value="{{$testimonial->title}}" class="form-control" id="floatingPassword" placeholder="work" required>
